...
void UValueGauge::SetAndBoundToGameplayAttribute(class UAbilitySystemComponent* AbilitySystemComponent, const FGameplayAttribute& Attribute, const FGameplayAttribute& MaxAttribute)
{
...
void UValueGauge::SetValue(float NewValue, float NewMaxValue)
{
    ...
    if (NewMaxValue ==0 )
    {
        UE_LOG(LogTemp, Warning, TEXT("Value Gauge: %s, Nex Max Value cant be 0!"), *GetName());
        return;
    }
